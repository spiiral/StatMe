...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "StatMe")
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        let userInterfaceStyle = UserDefaults.standard.integer(forKey: "interfaceStyle")
        print(userInterfaceStyle)
        window.overrideUserInterfaceStyle = userInterfaceStyle == 0 ? .light : .dark
        self.window = window
